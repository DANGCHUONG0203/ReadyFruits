...
export default function CheckoutPage() {
	...
	const validateForm = () => {
		...
		if (!formData.deliveryTime || !(formData.deliveryTime instanceof Date) || isNaN(formData.deliveryTime.getTime())) {
			newErrors.deliveryTime = 'Vui lòng chọn ngày giờ nhận hàng';
		}
		setErrors(newErrors);
						...
						<form onSubmit={handleSubmitOrder}>
							<div className="form-section">
								<h3 className="section-title">
									<span className="section-icon">👤</span> Thông tin khách hàng
								</h3>
							...
							<div className="form-section">
								<h3 className="section-title">
									<span className="section-icon">🏠</span> Địa chỉ giao hàng
								</h3>
								<div className="form-group">
								...
								<div className="form-group">
									...
									<input 
										...
										onChange={handleInputChange} 
										className={`form-input ${errors.receiverPhone ? 'error' : ''}`} 
								...
								<div className="form-group">
									...
									{formData.deliveryTime && (
										<div style={{marginTop: '4px', color: '#2ecc40', fontSize: '13px'}}>
											Đã chọn: {formatVietnamTime(formData.deliveryTime)}
										</div>
									)}
								</div>
								<div className="form-group">
							...
							<div className="form-section">
								<h3 className="section-title">
									<span className="section-icon">💳</span> Phương thức thanh toán
								</h3>
							...
							<div className="form-actions">
								...
								<button type="submit" className="submit-btn" disabled={loading}>
									{loading ? 'Đang xử lý...' : `Đặt hàng - ${formatPrice(getCartTotal())}`}
								</button>
							</div>
						</form>
					</div>
